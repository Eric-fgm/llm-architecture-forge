...
def main() -> None:
    ...
    # Wczytanie wymagań
    print("Podaj ścieżke do pliku z wymaganiami:")
    ...
    print(
        "Rozpoczęto analizę i generowanie architektury. To może potrwać kilkanaście sekund..."
    )
    result = chain.run({"requirements": requirements_text})

    print("\nGotowe! Zapisywanie do pliku output/architecture_output.md...")

    # Zapis do pliku wynikowego
    with open("output/architecture_output.md", "w", encoding="utf-8") as f:
    ...
    print("Zapisano pomyślnie. Sprawdź plik output/architecture_output.md.")
